...
# Installa pacchetti richiesti per pushover
RUN set -x && apt-get update && apt-get install -y python3 python3-pip && python3 -m pip install requests pyzm --break-system-packages
