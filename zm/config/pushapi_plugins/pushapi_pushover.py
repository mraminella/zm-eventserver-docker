...
param_dict = {
    ...
    #'sound':'tugboat',
    #'priority': 0,
    'device': 'galaxya345g', #### Device Galaxy A34 5G di Marco ####
...
def read_secrets(config='/config/secrets.ini'):
...
# -------- MAIN ---------------
zmlog.init(name='zmeventnotification_pushapi',override={'conf_path':'/config'})
